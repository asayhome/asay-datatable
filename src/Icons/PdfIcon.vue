<template>
  ...
  >
    ...
    >
      <path
        d="M 11.194 73.946 v 11.506 c 0 2.508 2.04 4.548 4.548 4.548 h 58.517 c 2.508 0 4.548 -2.04 4.548 -4.548 V 20.496 c 0 -1.214 -0.473 -2.356 -1.332 -3.216 L 61.526 1.332 C 60.667 0.473 59.525 0 58.31 0 H 15.742 c -2.508 0 -4.548 2.04 -4.548 4.548 V 43.16 l 0 0 V 73.946 z"
        style="
          stroke: none;
          stroke-width: 1;
          stroke-dasharray: none;
      ...
      />
      <path
        d="M 45.351 84.203 H 41.27 c -0.552 0 -1 -0.447 -1 -1 V 69.571 c 0 -0.553 0.448 -1 1 -1 h 4.082 c 2.278 0 4.13 1.853 4.13 4.13 v 7.371 C 49.481 82.35 47.629 84.203 45.351 84.203 z M 42.27 82.203 h 3.082 c 1.174 0 2.13 -0.956 2.13 -2.131 v -7.371 c 0 -1.175 -0.956 -2.13 -2.13 -2.13 H 42.27 V 82.203 z"
        style="
          stroke: none;
          stroke-width: 1;
          stroke-dasharray: none;
      ...
      />
      <path
        d="M 61.282 68.571 H 54.07 c -0.553 0 -1 0.447 -1 1 v 13.632 c 0 0.553 0.447 1 1 1 s 1 -0.447 1 -1 v -5.816 h 3.723 c 0.553 0 1 -0.447 1 -1 s -0.447 -1 -1 -1 H 55.07 v -4.815 h 6.212 c 0.553 0 1 -0.447 1 -1 S 61.835 68.571 61.282 68.571 z"
        style="
          stroke: none;
          stroke-width: 1;
          stroke-dasharray: none;
